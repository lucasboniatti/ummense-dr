...
- [x] Evidências de logs anexadas (quality gates + parity 10/10).
...
2. `FIXED` - Suíte parity expandida e executada com backend real ativo (`10 passed`).
3. `FIXED` - Evidências visuais foram anexadas (10 capturas por jornada, incluindo fluxos autenticados).
