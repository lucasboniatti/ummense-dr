...
export type TaskflowApiErrorCode = TaskflowErrorCode;
...
export interface FlowWithSeedColumns extends Flow {
  columns: FlowColumn[];
}
...
export interface TaskflowApiResponse<T> {
  data: T;
}

export interface TaskflowApiErrorPayload {
  error: string;
