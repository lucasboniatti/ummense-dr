      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Conecte sua workspace do Slack</p>
          </div>
        ...
        {slackIntegrations.length > 0 ? (
          ...
          <div className="p-8 bg-gray-50 rounded-lg border border-gray-200 text-center mb-6">
            <p className="text-gray-600 mb-4">Nenhuma integração Slack conectada</p>
            <button
              onClick={() => setShowSlackModal(true)}
              className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors"
            >
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Conecte seu servidor Discord</p>
          </div>
        ...
        {discordIntegrations.length > 0 ? (
          ...
          <div className="p-8 bg-gray-50 rounded-lg border border-gray-200 text-center">
            <p className="text-gray-600 mb-4">Nenhuma integração Discord conectada</p>
            <button
              onClick={() => setShowDiscordModal(true)}
              className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors"
            >
